classdef prosthesis < handle
    ...
    methods
        ...
        function learn(this, net, data)
            ...
            if ~strcmp(this.current_mode,'simulate') && mod(data.time,50)==0
        ...
        function update(this, net, data)
            ...
            if strcmp(this.current_mode,'simulate')
                ...
                this.changeTargetAngleOverTime(data,net,[((0:length(this.angles_to_simulate))*30000)',[this.angles_to_simulate,-1]']);
            end
