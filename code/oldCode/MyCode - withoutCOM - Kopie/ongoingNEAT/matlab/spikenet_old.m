classdef spikenet_old < handle
    ...
    methods
        ...
        function this = spikenet_old(numNeurons,spikingThreshold,settingsFile,savePath,equationParams, weightsMatrix)
        ...
        function rmsd = simulate( this, model_name, run_time, run_settings, trials_per_settings,save_trail_figures ,save_mean_figures)
            if nargin < 6
...
%                                    '##########################\n'),model_name,run_number,trial_number);
        ...
        function noise = getRandomNoise(this, voltage)
            ...
            idx = (0.5+0.5*ra) < 0.24; %approx 300Hz
