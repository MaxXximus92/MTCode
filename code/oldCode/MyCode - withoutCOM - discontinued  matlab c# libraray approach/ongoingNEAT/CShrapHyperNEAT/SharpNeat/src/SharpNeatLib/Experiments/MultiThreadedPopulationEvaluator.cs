...
namespace SharpNeatLib.Experiments
{
    ...
    {
        protected INetworkEvaluator networkEvaluator;
       ...
       protected ulong evaluationCount = 0;
        ...
        public MultiThreadedPopulationEvaluator(INetworkEvaluator networkEvaluator, IActivationFunction activationFn)
        {
            ...
            //ThreadPool.SetMaxThreads(HyperNEATParameters.numThreads,o);
        ...
        public void EvaluatePopulation(Population pop, EvolutionAlgorithm ea)
        {
            ...
            //Max, den code verstehe ich nicht aber ich lass ihn mal drin, man braucht sie auch ... warum?
        ...
        public static void evalNet(Object input)
        {
            ...
            else
            {
                ...
                Console.WriteLine("Genome Number " + e.nu + " " + (DateTime.Now.Subtract(dt)));
            }
