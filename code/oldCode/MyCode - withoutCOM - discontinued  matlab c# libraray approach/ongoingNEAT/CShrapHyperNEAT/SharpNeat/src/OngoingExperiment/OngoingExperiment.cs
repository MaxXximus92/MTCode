...
{
    public class OngoingExperiment : IExperiment
    {
        readonly double[,] netWeights;
        readonly double[,] netEqParams;
        int cPPNinputs;
        int cPPNoutputs;
        ...
        public OngoingExperiment(int cPPNinputs, int cPPNoutputs, double[,] netWeights, double[,] netEqParams, int[] esEmNum)
        {
            this.cPPNinputs = cPPNinputs;
            this.cPPNoutputs = cPPNoutputs;
            this.netWeights = netWeights;
            this.netEqParams = netEqParams;
            this.esEmNum = esEmNum;
        ...
        { 
                populationEvaluator = new OnGoingPopulationEvaluator(new OnGoingNetworkEvaluator(netWeights,netEqParams, esEmNum));
        }
    }
}
