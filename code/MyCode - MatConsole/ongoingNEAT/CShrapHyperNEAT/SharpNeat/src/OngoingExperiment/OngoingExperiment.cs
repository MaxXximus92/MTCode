...
namespace OngoingExperimentNS
{
    public class OngoingExperiment : IExperiment
    {
        ...
        public OngoingExperiment(int cPPNinputs, int cPPNoutputs, int[] esEmNum)
        {
        ...
        { 
                populationEvaluator = new OnGoingPopulationEvaluator(new OnGoingNetworkEvaluator(esEmNum));
        }
    }
}
