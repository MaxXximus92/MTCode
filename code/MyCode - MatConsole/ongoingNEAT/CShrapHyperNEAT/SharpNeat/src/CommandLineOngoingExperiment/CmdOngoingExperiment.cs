    ...
    class CmdOngoingExperiment
    {
        ...
        static void Main(string[] args)
        {
           ...
           // string genomeSavePath = "";
            ...
            Console.WriteLine("Test for correct number reading: HN Threshold={0}", HyperNEATParameters.threshold);
           ...
           // }
            Console.WriteLine("Closing Matlab Instances");
            ((OnGoingNetworkEvaluator)((MultiThreadedPopulationEvaluator)exp.PopulationEvaluator).networkEvaluator).closeMatlabInstances();
            //ExperimentParameters.runTime = 120000;
            //Console.WriteLine("Simulate best with runtime 120000");
           // PlotMatlabGraphs(genomeSavePath, (OnGoingPopulationEvaluator)exp.PopulationEvaluator,"simulate_120000_");
            Console.WriteLine("Done!");
            doubleWriter.Flush();
            doubleWriter.Close();
            // get time to write logfile
