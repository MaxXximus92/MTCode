...
scaleFactor=repelem(1.34,5);
scaleFactor = mat2str(scaleFactor);
savePath='C:\Users\Maximus Mutschler\Downloads\test';

numNeu= getModelParams('neuronTypes.mat',scaleFactor);
name = 'test';
...
runModel(name,train_time,savePath,'EquationParams.mat','connections.mat','result_rmsd', 'syncfile.txt',angles_to_learn,angles_to_simulate,angle_simulation_time,scaleFactor )
toc
