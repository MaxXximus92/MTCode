function [ ] = runModel(name, max_trainTime, savePath, equationParamsPath,connectionsPath,resultPath, syncPath,angles_to_learn,angles_to_simulate,angle_simulation_time,scaleFactors )
...
equationParams = loadEquationParams(equationParamsPath,scaleFactors);
...
net = spikenet(spikingThreshold,settings,savePath,scaleFactors,equationParams,initial_weights);
