classdef prosthesis < handle
    ...
    methods
        function this = prosthesis(angle_min,angle_max,draw_plot)
            this.draw_plot = draw_plot;
            ...
            if strcmp(this.current_mode,'ES->EM')
                ...
                if data.time>this.mode_start_time+500 && this.isTargetReached()
                    ...
                    if this.angle_to_learn <= length(this.angles_to_learn)
                        ...
                        this.current_mode = 'simulate'; %@m ok fängt gleich nach lernen simulieren an... soll so nicht sein
