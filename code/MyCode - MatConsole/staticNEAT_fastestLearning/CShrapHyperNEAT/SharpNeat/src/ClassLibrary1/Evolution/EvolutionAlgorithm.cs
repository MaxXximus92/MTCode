...
namespace SharpNeatLib.Evolution
{
	public class EvolutionAlgorithm
	{
        ...
        Dictionary<object, object> newConnectionGeneTable = new Dictionary<object, object>();
        Dictionary<object, object> newNeuronGeneStructTable = new Dictionary<object, object>();
		...
		public Dictionary<object, object> NewConnectionGeneTable
		{
			get
			{
		...
		public Dictionary<object, object> NewNeuronGeneStructTable
		{
			get
			{
...
//		}
		...
		private void UpdateFitnessStats()
		{
			...
			{
				List<object> championSpecies = new List<object>();
		...
		{
            Dictionary<object, object> connectionIdTable = new Dictionary<object, object>();
