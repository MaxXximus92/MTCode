...
namespace StaticExperimentNS
{
    public class StaticExperiment : IExperiment
    {
        ...
        public StaticExperiment(int cPPNinputs, int cPPNoutputs, int[] esEmNum)
        {
        ...
        { 
                populationEvaluator = new StaticPopulationEvaluator(new StaticNetworkEvaluator(esEmNum));
        }
    }
}
