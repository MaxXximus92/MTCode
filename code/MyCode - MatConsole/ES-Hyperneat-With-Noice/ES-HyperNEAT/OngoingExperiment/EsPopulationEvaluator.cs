...
{
    public class EsPopulationEvaluator : MultiThreadedPopulationEvaluator
    {

        public EsPopulationEvaluator(INetworkEvaluator eval)
            : base(eval, null)
        {
        ...
        public static void simulateNet(Object input)
        {
            ...
            ((EsNetworkEvaluator)(e.NetworkEvaluator)).simulateModel(e.Name);
        ...
        public static void plotNet(Object input)
        {
            ...
            sem2.Release();
            DateTime dt = DateTime.Now;
            ((EsNetworkEvaluator)(e.NetworkEvaluator)).plotMatlabGraphsAndSafeNetwork(network, e.Name);
