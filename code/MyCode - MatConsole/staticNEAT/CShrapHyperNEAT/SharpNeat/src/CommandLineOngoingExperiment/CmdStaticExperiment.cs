    ...
    class CmdOngoingExperiment
    {
        ...
        static void Main(string[] args)
        {
           ...
           // string genomeSavePath = "";
            ...
            for (int j = 0; j < maxGenerations; j++)
            {
                ...
                if (ea.BestGenome.Fitness > initialMaxFitness)
                {
                    ...
                    saveGenome(ea.BestGenome, genomeSavePath, String.Format("{0}_BestGen_Generation_{1}_Fitness_{2:0.#####}", ExperimentParameters.experimentName,j,ea.BestGenome.Fitness));
           ...
           // genList.Reverse();
            ...
            {
                saveGenome( genArray[i], genomeSavePath, String.Format("{0}_LastGeneration_Fitness_{1:0.#####}_order_{2}", ExperimentParameters.experimentName,genArray[i].Fitness,i));
            }
