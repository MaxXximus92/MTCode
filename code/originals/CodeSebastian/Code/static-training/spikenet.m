classdef spikenet < handle
    ...
    methods
        % constructor
        function this = spikenet(spikingThreshold,settingsFile)
            if (nargin > 0)
                ...
                this.weightsScale    = zeros(this.numNeurons,this.numNeurons);
        ...
        % train model
        function successfully = train(this, model_number, max_run_time)
