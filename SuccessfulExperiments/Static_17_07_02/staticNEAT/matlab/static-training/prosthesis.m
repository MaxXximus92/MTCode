classdef prosthesis < handle
    ...
    methods
        function this = prosthesis(angle_min,angle_max,max_train_time,plot)
            this.DRAW_PLOT = plot;
            this.max_train_time =max_train_time;
            this.angle_min = angle_min;
            this.angle_max = angle_max;
            this.angle_target = angle_min;
            this.angle_simulation_time=20000; %20000
            this.angles_to_learn=[angle_min,angle_max];
            this.angle_to_learn=1;
            
            this.angles_to_simulate = [angle_min,angle_max,(angle_max-angle_min)/2];
