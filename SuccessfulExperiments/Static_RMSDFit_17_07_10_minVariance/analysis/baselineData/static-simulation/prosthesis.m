classdef prosthesis < handle
    ...
    properties
        ...
        time_reached_angles;     %time when angle got reached
    ...
    methods
        function this = prosthesis(angle_min,angle_max,angle_start,angles_to_simulate,time_per_angle,save_figure)
            this.DRAW_PLOT= save_figure;
            ...
            this.time_reached_angles =zeros(1,length(this.angles_to_simulate));
        ...
        function update(this, net, data)
            ...
            if mod(data.time,50) == 0                
                ...
                if this.isTargetReached()
                    ...
                    indx= find(this.angles_to_simulate==this.angle_target);
                    if this.time_reached_angles(indx)==0
                       this.time_reached_angles(indx)= data.time;
                    end
                end
                % plot next angle
