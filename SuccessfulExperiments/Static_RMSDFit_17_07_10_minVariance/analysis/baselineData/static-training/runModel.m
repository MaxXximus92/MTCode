function [ ] = runModel(name, max_trainTime, savePath, equationParamsPath, weightsMatrixPath,DEsConnectionsPath,resultPath, syncPath,angles_to_learn,angles_to_simulate,angle_simulation_time )
