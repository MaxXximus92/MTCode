...
conProb = struct('P_ES',pd_es,'ES_IS',pes_is,'IS_IS',pis_is,'IS_ES',pis_es,'ES_EM',pes_em,'EM_IM',pem_im,'IM_IM',pim_im,'IM_EM',pim_em);
numNeuronTypes =struct('P',sum(dTypes),'ES',sum(esTypes),'IS',sum(isTypes),'EM',sum(emTypes),'IM',sum(imTypes));
end
