...
namespace SharpNeatLib.Evolution
{
	public class Population
	{
        ...
        Dictionary<object, object> speciesTable;			// Asecondary structure containing all of the genomes partitioned into their respective species. A Hashtable of GenomeList structures.
...
//		double fitnessAtLastPrunePhaseEnd=0.0;
		...
		public Dictionary<object, object> SpeciesTable
		{
			get
			{
				return speciesTable;
...
//		}
		...
		{
			//----- Build the table.
			speciesTable = new Dictionary<object, object>();
		...
		public void RedetermineSpeciation(EvolutionAlgorithm ea)
		{
            ...
            Dictionary<object, object> oldSpeciesTable = speciesTable;
...
//		}
		...
		List<object> speciesToRemove = new List<object>();
