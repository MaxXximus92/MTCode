...
namespace SharpNeatLib.NeatGenome
{
	...
	{	
		...
		// Temp tables.
		Dictionary<object,object> neuronConnectionLookupTable = null;
        Dictionary<object, object> neuronGeneTable = null;
        ...
        /// </summary>
        Dictionary<object, object> newConnectionGeneTable;
        Dictionary<object, object> newNeuronGeneTable;
		...
		public override IGenome CreateOffspring_Sexual(EvolutionAlgorithm ea, IGenome parent)
		{
			...
			{	// Provide a capacity figure to the new Hashtable. The offspring will be the same length (or thereabouts).
				newConnectionGeneTable = new Dictionary<object, object>(connectionGeneList.Count);
			...
			if(newNeuronGeneTable==null)
				newNeuronGeneTable = new Dictionary<object, object>(neuronGeneList.Count);
			else
...
//					}
		...
		private void Mutate_DeleteSimpleNeuronStructure(EvolutionAlgorithm ea)
		{
			...
			List<object> simpleNeuronIdList = new List<object>();
...
//		}
		...
		{
			neuronGeneTable = new Dictionary<object,object>();
		...
		private void BuildNeuronConnectionLookupTable()
		{
			...
			neuronConnectionLookupTable = new Dictionary<object, object>();
