classdef spikenet < handle
    ...
    methods
       ...
       function DEsWeights = getDEsWeights(this)
        ...
        %% train model
        function fitness = train(this, model_name, max_train_time,save_figures)
            if nargin < 3
                save_figures = false;
            end
            ...
            prost = prosthesis(0,135,max_train_time,save_figures); %@ m ok wichtig!!!! nicht 180°
