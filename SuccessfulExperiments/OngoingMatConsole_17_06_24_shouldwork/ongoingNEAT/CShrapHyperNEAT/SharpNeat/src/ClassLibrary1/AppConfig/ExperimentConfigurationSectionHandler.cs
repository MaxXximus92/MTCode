...
namespace SharpNeatLib.AppConfig
{
	...
	public class ExperimentConfigurationSectionHandler : IConfigurationSectionHandler
	{
		...
		public object Create(object parent, object configContext, System.Xml.XmlNode section)
		{
            ...
            List<ExperimentConfigInfo> oExperimentConfigInfoList = new List<ExperimentConfigInfo>();
			...
			return oExperimentConfigInfoList.ToArray();
		...
		private ExperimentConfigInfo ReadExperimentConfigInfo(XmlNode experimentNode)
		{
			...
			{	// Create an empty Dictionary<object,object> for consistency.
				eci.ParameterTable = new Dictionary<object,object>();
			}
		...
		/// <summary>
		/// Reads key-value pairs from teh parameters node into a Dictionary<object,object>.
		/// </summary>
		/// <param name="parametersNode"></param>
		/// <returns></returns>
		private Dictionary<object,object> ReadExperimentParameters(XmlNode parametersNode)
		{
			Dictionary<object,object> oParamTable = new Dictionary<object,object>();
