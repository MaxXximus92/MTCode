...
\section{general approach implementation}
...
The parameters for HyperNEAT in general and the implemented experiments can be set by specific configuration text files.
