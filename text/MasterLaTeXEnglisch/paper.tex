...
\floatstyle{plaintop} % move table caption to top
\restylefloat{table} % move table caption to top
...
\newacronym{snn}{SNN}{Spiking Artificial Neural Network}
\newacronym{es}{ES neuron}{excitatory sensory neuron}
\newacronym{is}{IS neuron}{inhibitory sensory neuron}
\newacronym{em}{EM neuron}{excitatory motory neuron}
\newacronym{im}{IM neuron}{inhibitory motory neuron}
\newacronym{p}{P neuron}{proprioceptive neuron}
...
%TODO Appendix picture sebastian algotizhm
% TODO weight calculations Sebastian
%TODO whole hyperneat algorithm
